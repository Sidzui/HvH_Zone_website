        ...
        <nav className="bg-gray-900/80 backdrop-blur-sm border-b border-pink-500/20 fixed w-full z-50">
          <div className="max-w-7xl mx-auto px-4">
            <div className="flex items-center justify-between h-16">
              ...
              {/* Steam Login Button */}
              <button className="bg-gradient-to-br from-blue-500 via-blue-600 to-blue-700 px-4 py-2 rounded-lg flex items-center space-x-2 hover:opacity-90 transition-all duration-200 shadow-lg hover:shadow-blue-500/20">
